namespace Microsoft.Samples.Wpf.D3D11Interop
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private readonly Ogre ogre;

        private bool ogreIsChanged = false;
        ...
        private void InitializeRendering()
        {
            ...
            ogre.TextureWidth = (int)host.ActualWidth;
            ogre.TextureHeight = (int)host.ActualHeight;
        ...
        {
            if (isNewSurface || ogreIsChanged)
            {
                ogre.DisposeRenderTarget();
                ogre.CreateTexture11(surface);
                ogre.InitRenderTarget();
                ogre.RenderOneFrame();
